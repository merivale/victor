...
var _merivale$victor$Theory_Short_Messages$scattered = F2(
	function (tally, vars) {
...
var _merivale$victor$Theory_Short_Messages$extended = F2(
...
var _merivale$victor$Theory_Short_Messages$regular = F2(
...
var _merivale$victor$Theory_Short_Messages$preordained = F2(
	function (time, vars) {
		return _elm_lang$core$Native_Utils.update(
			vars,
			{
...
var _merivale$victor$Theory_Short_Messages$prior = function (vars) {
	return vars.prior ? _elm_lang$core$Result$Err('PRIOR messages cannot be made PRIOR') : _elm_lang$core$Result$Ok(
		_elm_lang$core$Native_Utils.update(
			vars,
			{prior: true}));
};
var _merivale$victor$Theory_Short_Messages$past = F2(
	function (time, vars) {
		return vars.past ? _elm_lang$core$Result$Err('PAST messages cannot be made PAST') : _elm_lang$core$Result$Ok(
			_elm_lang$core$Native_Utils.update(
				vars,
				{
					past: true,
...
var _merivale$victor$Theory_Short_Messages$negative = function (vars) {
	return _elm_lang$core$Native_Utils.update(
		vars,
		{
...
var _merivale$victor$Theory_Short_Messages$plain = function (_p0) {
	var _p1 = _p0;
	return {
		object: _p1._0,
		past: false,
...
var _merivale$victor$Theory_Short_Messages$explode = function (message) {
	var _p2 = message;
	switch (_p2.ctor) {
		case 'Plain':
			return _elm_lang$core$Result$Ok(
				_merivale$victor$Theory_Short_Messages$plain(_p2._0));
		case 'NEGATIVE':
			return A2(
				_elm_lang$core$Result$map,
				_merivale$victor$Theory_Short_Messages$negative,
				_merivale$victor$Theory_Short_Messages$explode(_p2._0));
		case 'PAST':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Short_Messages$past(_p2._0),
				_merivale$victor$Theory_Short_Messages$explode(_p2._1));
		case 'PRIOR':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Short_Messages$prior,
				_merivale$victor$Theory_Short_Messages$explode(_p2._0));
		case 'PREORDAINED':
			return A2(
				_elm_lang$core$Result$map,
				_merivale$victor$Theory_Short_Messages$preordained(_p2._0),
				_merivale$victor$Theory_Short_Messages$explode(_p2._1));
		case 'REGULAR':
			return A2(
				_elm_lang$core$Result$map,
				_merivale$victor$Theory_Short_Messages$regular(_p2._0),
				_merivale$victor$Theory_Short_Messages$explode(_p2._1));
		case 'EXTENDED':
			return A2(
				_elm_lang$core$Result$map,
				_merivale$victor$Theory_Short_Messages$extended(_p2._0),
				_merivale$victor$Theory_Short_Messages$explode(_p2._1));
		default:
			return A2(
				_elm_lang$core$Result$map,
				_merivale$victor$Theory_Short_Messages$scattered(_p2._0),
				_merivale$victor$Theory_Short_Messages$explode(_p2._1));
	}
};
var _merivale$victor$Theory_Short_Messages$Vars = F7(
	function (a, b, c, d, e, f, g) {
		return {object: a, past: b, prior: c, pre: d, pivot: e, balances: f, post: g};
	});
var _merivale$victor$Theory_Short_Messages$SCATTERED = F2(
	function (a, b) {
...
var _merivale$victor$Theory_Short_Messages$PRIOR = function (a) {
...
var _merivale$victor$Theory_Short_Messages$NEGATIVE = function (a) {
	return {ctor: 'NEGATIVE', _0: a};
};
var _merivale$victor$Theory_Short_Messages$Plain = function (a) {
	return {ctor: 'Plain', _0: a};
};

var _merivale$victor$Interface_Messages_Short$scattered = F2(
	function (tally, message) {
		...
		if (_p0.ctor === 'Nothing') {
			...
			return _elm_lang$core$Result$Ok(
				A2(_merivale$victor$Theory_Short_Messages$SCATTERED, _p0._0, message));
		}
	});
var _merivale$victor$Interface_Messages_Short$extended = F2(
	function (duration, message) {
		...
		if (_p1.ctor === 'Nothing') {
			...
			return _elm_lang$core$Result$Ok(
				A2(_merivale$victor$Theory_Short_Messages$EXTENDED, _p1._0, message));
		}
	});
var _merivale$victor$Interface_Messages_Short$regular = F2(
	function (string, message) {
		return _elm_lang$core$Result$Ok(
			A2(_merivale$victor$Theory_Short_Messages$REGULAR, string, message));
	});
var _merivale$victor$Interface_Messages_Short$preordained = F2(
	function (string, message) {
		return _elm_lang$core$Result$Ok(
			A2(_merivale$victor$Theory_Short_Messages$PREORDAINED, string, message));
	});
var _merivale$victor$Interface_Messages_Short$prior = function (message) {
	return _elm_lang$core$Result$Ok(
		_merivale$victor$Theory_Short_Messages$PRIOR(message));
};
var _merivale$victor$Interface_Messages_Short$past = F2(
	function (time, message) {
		return _elm_lang$core$Result$Ok(
			A2(_merivale$victor$Theory_Short_Messages$PAST, time, message));
	});
var _merivale$victor$Interface_Messages_Short$negative = function (message) {
	return _elm_lang$core$Result$Ok(
		_merivale$victor$Theory_Short_Messages$NEGATIVE(message));
};
var _merivale$victor$Interface_Messages_Short$elaborate = F2(
	function (elaborations, message) {
		elaborate:
		while (true) {
			var _p2 = _elm_lang$core$List$head(elaborations);
			if (_p2.ctor === 'Nothing') {
				...
				switch (_p3.ctor) {
					case 'MakeNEGATIVE':
						return A2(
							_elm_lang$core$Result$andThen,
							_merivale$victor$Interface_Messages_Short$elaborate(
								A2(_elm_lang$core$List$drop, 1, elaborations)),
							_merivale$victor$Interface_Messages_Short$negative(message));
					case 'MakePAST':
						return A2(
							_elm_lang$core$Result$andThen,
							_merivale$victor$Interface_Messages_Short$elaborate(
								A2(_elm_lang$core$List$drop, 1, elaborations)),
							A2(_merivale$victor$Interface_Messages_Short$past, _p4.string1, message));
					case 'MakePRIOR':
						return A2(
							_elm_lang$core$Result$andThen,
							_merivale$victor$Interface_Messages_Short$elaborate(
								A2(_elm_lang$core$List$drop, 1, elaborations)),
							_merivale$victor$Interface_Messages_Short$prior(message));
					case 'MakePREORDAINED':
						return A2(
							_elm_lang$core$Result$andThen,
							_merivale$victor$Interface_Messages_Short$elaborate(
								A2(_elm_lang$core$List$drop, 1, elaborations)),
							A2(_merivale$victor$Interface_Messages_Short$preordained, _p4.string1, message));
					case 'MakeREGULAR':
						return A2(
							_elm_lang$core$Result$andThen,
							_merivale$victor$Interface_Messages_Short$elaborate(
								A2(_elm_lang$core$List$drop, 1, elaborations)),
							A2(_merivale$victor$Interface_Messages_Short$regular, _p4.string1, message));
					case 'MakeEXTENDED':
						return A2(
							_elm_lang$core$Result$andThen,
							_merivale$victor$Interface_Messages_Short$elaborate(
								A2(_elm_lang$core$List$drop, 1, elaborations)),
							A2(_merivale$victor$Interface_Messages_Short$extended, _p4.string1, message));
					case 'MakeSCATTERED':
						return A2(
							_elm_lang$core$Result$andThen,
							_merivale$victor$Interface_Messages_Short$elaborate(
								A2(_elm_lang$core$List$drop, 1, elaborations)),
							A2(_merivale$victor$Interface_Messages_Short$scattered, _p4.string1, message));
					default:
						var _v4 = A2(_elm_lang$core$List$drop, 1, elaborations),
							_v5 = message;
						elaborations = _v4;
						message = _v5;
						continue elaborate;
...
var _merivale$victor$Interface_Messages_Short$propertyEmpty = function (status) {
	var _p5 = status;
	if ((_p5.ctor === 'Just') && (_p5._0.ctor === 'Absolute')) {
		return _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$String$length(_p5._0._0),
			0);
	} else {
		return false;
	}
};
var _merivale$victor$Interface_Messages_Short$verbalityEmpty = function (verbality) {
	var _p6 = verbality;
	if (_p6.ctor === 'Do') {
		return _elm_lang$core$Native_Utils.eq(
...
var _merivale$victor$Interface_Messages_Short$plain = F4(
	function (object, verbality, status, balances) {
		return _merivale$victor$Interface_Messages_Short$verbalityEmpty(verbality) ? _elm_lang$core$Result$Err('please enter a verb for the verbality') : (_merivale$victor$Interface_Messages_Short$propertyEmpty(status) ? _elm_lang$core$Result$Err('please enter an adjective for the status') : _elm_lang$core$Result$Ok(
			_merivale$victor$Theory_Short_Messages$Plain(
				{
					ctor: '_Tuple2',
					_0: object,
					_1: {
...
var _merivale$victor$Interface_Messages_Short$message = function (model) {
	return A2(
		_elm_lang$core$Result$andThen,
		_merivale$victor$Interface_Messages_Short$elaborate(model.elaborations),
		A4(_merivale$victor$Interface_Messages_Short$plain, model.object, model.verbality, model.status, model.balances));
};
...
var _merivale$victor$Theory_Short_Sentences$verbPhrase = function (vars) {
	var _p0 = A2(_merivale$victor$Theory_Words_Fulcrums$fulcrum, vars.prior, vars.pivot);
	var base = _p0._0;
	var rest = _p0._1;
...
var _merivale$victor$Theory_Short_Sentences$predicate = function (vars) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_merivale$victor$Theory_Short_Sentences$verbPhrase(vars),
		A2(
			_elm_lang$core$Basics_ops['++'],
			A2(
				_elm_lang$core$List$map,
...
var _merivale$victor$Theory_Short_Sentences$subject = function (object) {
	return _merivale$victor$Theory_Words_Pronouns$direct1(object);
};
var _merivale$victor$Theory_Short_Sentences$implode = function (vars) {
	return A2(
		_elm_lang$core$String$join,
		' ',
		{
			ctor: '::',
			_0: _merivale$victor$Theory_Short_Sentences$subject(vars.object),
			_1: _merivale$victor$Theory_Short_Sentences$predicate(vars)
		});
};
var _merivale$victor$Theory_Short_Sentences$sentence = function (message) {
	return A2(
		_elm_lang$core$Result$map,
		_merivale$victor$Theory_Short_Sentences$implode,
...
var _merivale$victor$Short$view = function (model) {
	var result = A2(
		_elm_lang$core$Result$andThen,
		_merivale$victor$Theory_Short_Sentences$sentence,
		_merivale$victor$Interface_Messages_Short$message(model));
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _merivale$victor$Short$main = _elm_lang$html$Html$beginnerProgram(
	{
		model: _merivale$victor$Interface_Model_State$initial(_merivale$victor$Interface_Model_Types$ShortTheory),
		update: _merivale$victor$Interface_Model_State$update,
		view: _merivale$victor$Short$view
	})();

var Elm = {};
Elm['Short'] = Elm['Short'] || {};
if (typeof _merivale$victor$Short$main !== 'undefined') {
    _merivale$victor$Short$main(Elm['Short'], 'Short', undefined);
}
