...
var _merivale$victor$Short$nucleusBody = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _merivale$victor$Short$nucleusHeading = function (model) {
	...
	return (_elm_lang$core$Native_Utils.cmp(
		...
		{
			ctor: '::',
			_0: A2(_merivale$victor$Short$plusButton, -1, model.plus),
			_1: {
				ctor: '::',
				_0: title,
				_1: {
...
var _merivale$victor$Short$nucleusInput = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _merivale$victor$Short$nucleusHeading(model),
			_1: {
				ctor: '::',
				_0: A2(_merivale$victor$Short$elaborationButtons, -1, model.plus),
				_1: {
					ctor: '::',
					_0: _merivale$victor$Short$nucleusBody(model),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _merivale$victor$Short$input = F2(
	function (elaborations, model) {
		...
		if (_p1.ctor === 'Nothing') {
			return _merivale$victor$Short$nucleusInput(model);
		} else {
			var subContent = A2(
