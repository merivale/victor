...
var _merivale$victor$Theory_Long_Messages$swapPastForPrior = function (vars) {
...
var _merivale$victor$Theory_Long_Messages$scattered = F2(
	function (tally, vars) {
		return _elm_lang$core$Native_Utils.update(
			vars,
			{
...
var _merivale$victor$Theory_Long_Messages$extended = F2(
...
var _merivale$victor$Theory_Long_Messages$regular = F3(
...
var _merivale$victor$Theory_Long_Messages$preordained = F3(
...
var _merivale$victor$Theory_Long_Messages$displaced = F2(
	function (displacer, vars) {
		if (!_elm_lang$core$Native_Utils.eq(vars.modality, _elm_lang$core$Maybe$Nothing)) {
			...
			if (_p2.ctor === 'Primary') {
				return A2(
					_elm_lang$core$Result$map,
					_merivale$victor$Theory_Long_Messages$primary(_p2._0),
					_merivale$victor$Theory_Long_Messages$swapPastForPrior(vars));
			} else {
				return _merivale$victor$Theory_Long_Messages$swapPastForPrior(
					_elm_lang$core$Native_Utils.update(
						vars,
						{
							modality: _elm_lang$core$Maybe$Just(_p2._0)
						}));
			}
		}
	});
...
var _merivale$victor$Theory_Long_Messages$past = F2(
	function (time, vars) {
...
var _merivale$victor$Theory_Long_Messages$negative = function (vars) {
	var _p3 = vars.modality;
	if (_p3.ctor === 'Nothing') {
		return _elm_lang$core$Result$Ok(
			_elm_lang$core$Native_Utils.update(
				vars,
...
var _merivale$victor$Theory_Long_Messages$plain = function (_p4) {
	var _p5 = _p4;
	return {
		object: _p5._0,
		past: false,
...
var _merivale$victor$Theory_Long_Messages$explode = function (message) {
	var _p6 = message;
	switch (_p6.ctor) {
		case 'Plain':
			return _elm_lang$core$Result$Ok(
				_merivale$victor$Theory_Long_Messages$plain(_p6._0));
		case 'NEGATIVE':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Long_Messages$negative,
				_merivale$victor$Theory_Long_Messages$explode(_p6._0));
		case 'PAST':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Long_Messages$past(_p6._0),
				_merivale$victor$Theory_Long_Messages$explode(_p6._1));
		case 'PRIOR':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Long_Messages$prior,
				_merivale$victor$Theory_Long_Messages$explode(_p6._0));
		case 'DISPLACED':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Long_Messages$displaced(_p6._0),
				_merivale$victor$Theory_Long_Messages$explode(_p6._1));
		case 'PREORDAINED':
			return A2(
				_elm_lang$core$Result$andThen,
				A2(_merivale$victor$Theory_Long_Messages$preordained, _p6._0, _p6._1),
				_merivale$victor$Theory_Long_Messages$explode(_p6._2));
		case 'REGULAR':
			return A2(
				_elm_lang$core$Result$andThen,
				A2(_merivale$victor$Theory_Long_Messages$regular, _p6._0, _p6._1),
				_merivale$victor$Theory_Long_Messages$explode(_p6._2));
		case 'EXTENDED':
			return A2(
				_elm_lang$core$Result$map,
				_merivale$victor$Theory_Long_Messages$extended(_p6._0),
				_merivale$victor$Theory_Long_Messages$explode(_p6._1));
		default:
			return A2(
				_elm_lang$core$Result$map,
				_merivale$victor$Theory_Long_Messages$scattered(_p6._0),
				_merivale$victor$Theory_Long_Messages$explode(_p6._1));
	}
};
var _merivale$victor$Theory_Long_Messages$Vars = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _merivale$victor$Theory_Long_Messages$Displaced = F3(
	function (a, b, c) {
...
var _merivale$victor$Theory_Long_Messages$PRIOR = function (a) {
...
var _merivale$victor$Theory_Long_Messages$NEGATIVE = function (a) {
	return {ctor: 'NEGATIVE', _0: a};
};
var _merivale$victor$Theory_Long_Messages$Plain = function (a) {
	return {ctor: 'Plain', _0: a};
};

var _merivale$victor$Interface_Messages_Long$scattered = F2(
	function (tally, message) {
		...
		if (_p0.ctor === 'Nothing') {
			...
			return _elm_lang$core$Result$Ok(
				A2(_merivale$victor$Theory_Long_Messages$SCATTERED, _p0._0, message));
		}
	});
var _merivale$victor$Interface_Messages_Long$extended = F2(
	function (duration, message) {
		...
		if (_p1.ctor === 'Nothing') {
			...
			return _elm_lang$core$Result$Ok(
				A2(_merivale$victor$Theory_Long_Messages$EXTENDED, _p1._0, message));
		}
	});
var _merivale$victor$Interface_Messages_Long$prior = function (message) {
	return _elm_lang$core$Result$Ok(
		_merivale$victor$Theory_Long_Messages$PRIOR(message));
};
var _merivale$victor$Interface_Messages_Long$past = F2(
	function (time, message) {
		return _elm_lang$core$Result$Ok(
			A2(_merivale$victor$Theory_Long_Messages$PAST, time, message));
	});
var _merivale$victor$Interface_Messages_Long$negative = function (message) {
	return _elm_lang$core$Result$Ok(
		_merivale$victor$Theory_Long_Messages$NEGATIVE(message));
};
var _merivale$victor$Interface_Messages_Long$propertyEmpty = function (status) {
	var _p2 = status;
	if ((_p2.ctor === 'Just') && (_p2._0.ctor === 'Absolute')) {
		return _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$String$length(_p2._0._0),
			0);
	} else {
		return false;
	}
};
var _merivale$victor$Interface_Messages_Long$verbalityEmpty = function (verbality) {
	var _p3 = verbality;
	if (_p3.ctor === 'Do') {
		return _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$String$length(_p3._0),
			0);
	} else {
		return false;
	}
};
var _merivale$victor$Interface_Messages_Long$displaced = F2(
	function (displacer, message) {
		var _p4 = displacer;
		if (_p4.ctor === 'Nothing') {
			return _elm_lang$core$Result$Err('please enter a displacer for the DISPLACED elaboration');
		} else {
			if (_p4._0.ctor === 'Primary') {
				var _p6 = _p4._0._0._0;
				var _p5 = _p4._0._0._1;
				return _merivale$victor$Interface_Messages_Long$verbalityEmpty(_p6) ? _elm_lang$core$Result$Err('please enter a verb for the DISPLACED verbality') : (_merivale$victor$Interface_Messages_Long$propertyEmpty(_p5) ? _elm_lang$core$Result$Err('please enter an adjective for the DISPLACED status') : _elm_lang$core$Result$Ok(
					A2(
						_merivale$victor$Theory_Long_Messages$DISPLACED,
				...
				return _elm_lang$core$Result$Ok(
					A2(
						_merivale$victor$Theory_Long_Messages$DISPLACED,
						_merivale$victor$Theory_Long_Displacers$Secondary(_p4._0._0),
						message));
			}
		}
	});
var _merivale$victor$Interface_Messages_Long$preordained = F3(
	function (displacer, string, message) {
		var _p7 = displacer;
		if (_p7.ctor === 'Nothing') {
			return _elm_lang$core$Result$Ok(
				A3(_merivale$victor$Theory_Long_Messages$PREORDAINED, displacer, string, message));
		} else {
			if (_p7._0.ctor === 'Primary') {
				return _merivale$victor$Interface_Messages_Long$verbalityEmpty(_p7._0._0._0) ? _elm_lang$core$Result$Err('please enter a verb for the PREORDAINED verbality') : (_merivale$victor$Interface_Messages_Long$propertyEmpty(_p7._0._0._1) ? _elm_lang$core$Result$Err('please enter an adjective for the PREORDAINED status') : _elm_lang$core$Result$Ok(
					A3(_merivale$victor$Theory_Long_Messages$PREORDAINED, displacer, string, message)));
			} else {
				return _elm_lang$core$Result$Ok(
					A3(_merivale$victor$Theory_Long_Messages$PREORDAINED, displacer, string, message));
...
var _merivale$victor$Interface_Messages_Long$regular = F3(
	function (displacer, string, message) {
		var _p8 = displacer;
		if (_p8.ctor === 'Nothing') {
			return _elm_lang$core$Result$Ok(
				A3(_merivale$victor$Theory_Long_Messages$REGULAR, displacer, string, message));
		} else {
			if (_p8._0.ctor === 'Primary') {
				return _merivale$victor$Interface_Messages_Long$verbalityEmpty(_p8._0._0._0) ? _elm_lang$core$Result$Err('please enter a verb for the REGULAR verbality') : (_merivale$victor$Interface_Messages_Long$propertyEmpty(_p8._0._0._1) ? _elm_lang$core$Result$Err('please enter an adjective for the REGULAR status') : _elm_lang$core$Result$Ok(
					A3(_merivale$victor$Theory_Long_Messages$REGULAR, displacer, string, message)));
			} else {
				return _elm_lang$core$Result$Ok(
					A3(_merivale$victor$Theory_Long_Messages$REGULAR, displacer, string, message));
...
var _merivale$victor$Interface_Messages_Long$elaborate = F2(
	function (elaborations, message) {
		elaborate:
		while (true) {
			var _p9 = _elm_lang$core$List$head(elaborations);
			if (_p9.ctor === 'Nothing') {
				return _elm_lang$core$Result$Ok(message);
			} else {
				var _p11 = _p9._0;
				var _p10 = _p11.recipe;
				switch (_p10.ctor) {
					case 'MakeNEGATIVE':
						return A2(
							_elm_lang$core$Result$andThen,
							_merivale$victor$Interface_Messages_Long$elaborate(
								A2(_elm_lang$core$List$drop, 1, elaborations)),
							_merivale$victor$Interface_Messages_Long$negative(message));
					case 'MakePAST':
						return A2(
							_elm_lang$core$Result$andThen,
							_merivale$victor$Interface_Messages_Long$elaborate(
								A2(_elm_lang$core$List$drop, 1, elaborations)),
							A2(_merivale$victor$Interface_Messages_Long$past, _p11.string1, message));
					case 'MakePRIOR':
						return A2(
							_elm_lang$core$Result$andThen,
							_merivale$victor$Interface_Messages_Long$elaborate(
								A2(_elm_lang$core$List$drop, 1, elaborations)),
							_merivale$victor$Interface_Messages_Long$prior(message));
					case 'MakeDISPLACED':
						return A2(
							_elm_lang$core$Result$andThen,
							_merivale$victor$Interface_Messages_Long$elaborate(
								A2(_elm_lang$core$List$drop, 1, elaborations)),
							A2(_merivale$victor$Interface_Messages_Long$displaced, _p11.displacer, message));
					case 'MakePREORDAINED':
						return A2(
							_elm_lang$core$Result$andThen,
							_merivale$victor$Interface_Messages_Long$elaborate(
								A2(_elm_lang$core$List$drop, 1, elaborations)),
							A3(_merivale$victor$Interface_Messages_Long$preordained, _p11.displacer, _p11.string1, message));
					case 'MakeREGULAR':
						return A2(
							_elm_lang$core$Result$andThen,
							_merivale$victor$Interface_Messages_Long$elaborate(
								A2(_elm_lang$core$List$drop, 1, elaborations)),
							A3(_merivale$victor$Interface_Messages_Long$regular, _p11.displacer, _p11.string1, message));
					case 'MakeEXTENDED':
						return A2(
							_elm_lang$core$Result$andThen,
							_merivale$victor$Interface_Messages_Long$elaborate(
								A2(_elm_lang$core$List$drop, 1, elaborations)),
							A2(_merivale$victor$Interface_Messages_Long$extended, _p11.string1, message));
					case 'MakeSCATTERED':
						return A2(
							_elm_lang$core$Result$andThen,
							_merivale$victor$Interface_Messages_Long$elaborate(
								A2(_elm_lang$core$List$drop, 1, elaborations)),
							A2(_merivale$victor$Interface_Messages_Long$scattered, _p11.string1, message));
					default:
						var _v9 = A2(_elm_lang$core$List$drop, 1, elaborations),
							_v10 = message;
						elaborations = _v9;
						message = _v10;
						continue elaborate;
...
var _merivale$victor$Interface_Messages_Long$plain = F4(
	function (object, verbality, status, balances) {
		return _merivale$victor$Interface_Messages_Long$verbalityEmpty(verbality) ? _elm_lang$core$Result$Err('please enter a verb for the verbality') : (_merivale$victor$Interface_Messages_Long$propertyEmpty(status) ? _elm_lang$core$Result$Err('please enter an adjective for the status') : _elm_lang$core$Result$Ok(
			_merivale$victor$Theory_Long_Messages$Plain(
				{
					ctor: '_Tuple2',
					_0: object,
					_1: {
...
var _merivale$victor$Interface_Messages_Long$message = function (model) {
	return A2(
		_elm_lang$core$Result$andThen,
		_merivale$victor$Interface_Messages_Long$elaborate(model.elaborations),
		A4(_merivale$victor$Interface_Messages_Long$plain, model.object, model.verbality, model.status, model.balances));
};
...
var _merivale$victor$Theory_Long_Sentences$baseVerbPhrase = F2(
	function (addTo, _p0) {
		var _p1 = _p0;
		var _p3 = _p1.pre;
		var newPre = addTo ? {ctor: '::', _0: 'to', _1: _p3} : _p3;
		var _p2 = A2(_merivale$victor$Theory_Words_Fulcrums$fulcrum, _p1.prior, _p1.pivot);
		var base = _p2._0;
		var rest = _p2._1;
		return A2(
			_elm_lang$core$String$join,
...
var _merivale$victor$Theory_Long_Sentences$verbPhrase = function (vars) {
	var _p4 = A2(_merivale$victor$Theory_Words_Fulcrums$fulcrum, vars.prior, vars.pivot);
	var base = _p4._0;
	var rest = _p4._1;
...
var _merivale$victor$Theory_Long_Sentences$predicate = function (vars) {
	var _p6 = vars.modality;
	if (_p6.ctor === 'Nothing') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			_merivale$victor$Theory_Long_Sentences$verbPhrase(vars),
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(
					_elm_lang$core$List$map,
					_merivale$victor$Theory_Long_Sentences$baseVerbPhrase(true),
					vars.displaced),
				A2(
					_elm_lang$core$Basics_ops['++'],
					A2(
						_elm_lang$core$List$map,
						_merivale$victor$Theory_Words_Counters$counter(vars.object),
						vars.balances),
		...
		return A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$List$map,
					_merivale$victor$Theory_Long_Sentences$baseVerbPhrase(addTo),
...
var _merivale$victor$Theory_Long_Sentences$subject = function (object) {
	return _merivale$victor$Theory_Words_Pronouns$direct1(object);
};
var _merivale$victor$Theory_Long_Sentences$implode = function (vars) {
	return A2(
		_elm_lang$core$String$join,
		' ',
		{
			ctor: '::',
			_0: _merivale$victor$Theory_Long_Sentences$subject(vars.object),
			_1: _merivale$victor$Theory_Long_Sentences$predicate(vars)
		});
};
var _merivale$victor$Theory_Long_Sentences$sentence = function (message) {
	return A2(
		_elm_lang$core$Result$map,
		_merivale$victor$Theory_Long_Sentences$implode,
		_merivale$victor$Theory_Long_Messages$explode(message));
};

var _merivale$victor$Long$help = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Victor is a model of the English language, thought of as a code for processing '),
							_1: {
								ctor: '::',
								_0: A2(
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text(' (structured arrangements of informational choices) into '),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$em,
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('sentences'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html$text(' (strings of words). Use the blue input box directly above to generate your message; the corresponding sentence will show up in the green output box at the top.'),
											_1: {ctor: '[]'}
										}
									}
								}
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('For exposition purposes, the model is divided into four layers of increasing complexity. If you are new to the theory, start with '),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$href('plain.html'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Plain Messages'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(', and move up from there. See the '),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$a,
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('README'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html$text(' for further details.'),
												_1: {ctor: '[]'}
											}
										}
									}
...
var _merivale$victor$Long$elaborationButton = F2(
	function (index, recipe) {
...
var _merivale$victor$Long$elaborationButtons = F2(
	function (index, plus) {
		var $class = plus ? 'elaborations active' : 'elaborations';
		return A2(
			_elm_lang$html$Html$div,
			...
			},
			{
				...
				_0: A2(
					...
					A2(
						_elm_lang$core$List$map,
						_merivale$victor$Long$elaborationButton(index),
						{
							ctor: '::',
							_0: _merivale$victor$Interface_Model_Types$MakeNEGATIVE,
							_1: {
...
var _merivale$victor$Long$plusButton = F2(
	function (index, plus) {
		var signal = (_elm_lang$core$Native_Utils.cmp(index, 0) < 0) ? _merivale$victor$Interface_Model_Types$TogglePlus : _merivale$victor$Interface_Model_Types$ToggleElaborationPlus(index);
...
var _merivale$victor$Long$elaborationBody = F4(
...
var _merivale$victor$Long$elaborationHeading = F2(
	function (index, elaboration) {
		return A2(
			_elm_lang$html$Html$div,
			{
			...
			{
				ctor: '::',
				_0: A2(_merivale$victor$Long$plusButton, index, elaboration.plus),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
...
var _merivale$victor$Long$elaborationInput = F4(
	function (balanceCount, index, elaboration, subContent) {
		return A2(
			_elm_lang$html$Html$div,
			{
			...
			{
				ctor: '::',
				_0: A2(_merivale$victor$Long$elaborationHeading, index, elaboration),
				_1: {
					ctor: '::',
					_0: A2(_merivale$victor$Long$elaborationButtons, index, elaboration.plus),
					_1: {
						ctor: '::',
						_0: A4(_merivale$victor$Long$elaborationBody, balanceCount, index, elaboration, subContent),
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _merivale$victor$Long$input = F2(
	function (elaborations, model) {
		var _p1 = _elm_lang$core$List$head(elaborations);
		if (_p1.ctor === 'Nothing') {
			return A2(_merivale$victor$Interface_View_Nucleus$nucleus, _merivale$victor$Interface_Model_Types$LongTheory, model);
		} else {
			var subContent = A2(
				_merivale$victor$Long$input,
				A2(_elm_lang$core$List$drop, 1, elaborations),
				model);
			var index = _elm_lang$core$List$length(elaborations) - 1;
			return A4(
				_merivale$victor$Long$elaborationInput,
				_elm_lang$core$List$length(model.balances),
				index,
				_p1._0,
				subContent);
...
var _merivale$victor$Long$view = function (model) {
	var result = A2(
		_elm_lang$core$Result$andThen,
		_merivale$victor$Theory_Long_Sentences$sentence,
		_merivale$victor$Interface_Messages_Long$message(model));
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _merivale$victor$Interface_View_Examples$examples(_merivale$victor$Interface_Model_Types$LongTheory),
				_1: {
					ctor: '::',
					_0: A2(
						_merivale$victor$Long$input,
...
var _merivale$victor$Long$main = _elm_lang$html$Html$beginnerProgram(
	{
		model: _merivale$victor$Interface_Model_State$initial(_merivale$victor$Interface_Model_Types$LongTheory),
		update: _merivale$victor$Interface_Model_State$update,
		view: _merivale$victor$Long$view
	})();

var Elm = {};
Elm['Long'] = Elm['Long'] || {};
if (typeof _merivale$victor$Long$main !== 'undefined') {
    _merivale$victor$Long$main(Elm['Long'], 'Long', undefined);
}
