...
var _merivale$victor$Victor$elaborationButton = F2(
	function (index, recipe) {
...
var _merivale$victor$Victor$elaborationButtons = F2(
	function (index, plus) {
		var $class = plus ? 'elaborations active' : 'elaborations';
		return A2(
			_elm_lang$html$Html$div,
			...
			},
			{
				...
				_0: A2(
					...
					A2(
						_elm_lang$core$List$map,
						_merivale$victor$Victor$elaborationButton(index),
						{
							ctor: '::',
							_0: _merivale$victor$Interface_Model_Types$MakeNEGATIVE,
							_1: {
...
var _merivale$victor$Victor$plusButton = F2(
	function (index, plus) {
		var signal = (_elm_lang$core$Native_Utils.cmp(index, 0) < 0) ? _merivale$victor$Interface_Model_Types$TogglePlus : _merivale$victor$Interface_Model_Types$ToggleElaborationPlus(index);
...
var _merivale$victor$Victor$elaborationBody = F4(
...
var _merivale$victor$Victor$elaborationHeading = F2(
	function (index, elaboration) {
		return A2(
			_elm_lang$html$Html$div,
			{
			...
			{
				ctor: '::',
				_0: A2(_merivale$victor$Victor$plusButton, index, elaboration.plus),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
...
var _merivale$victor$Victor$elaborationInput = F4(
	function (balanceCount, index, elaboration, subContent) {
		return A2(
			_elm_lang$html$Html$div,
			{
			...
			{
				ctor: '::',
				_0: A2(_merivale$victor$Victor$elaborationHeading, index, elaboration),
				_1: {
					ctor: '::',
					_0: A2(_merivale$victor$Victor$elaborationButtons, index, elaboration.plus),
					_1: {
						ctor: '::',
						_0: A4(_merivale$victor$Victor$elaborationBody, balanceCount, index, elaboration, subContent),
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _merivale$victor$Victor$input = F2(
	function (elaborations, model) {
		var _p1 = _elm_lang$core$List$head(elaborations);
		if (_p1.ctor === 'Nothing') {
			return A2(_merivale$victor$Interface_View_Nucleus$nucleus, _merivale$victor$Interface_Model_Types$FullTheory, model);
		} else {
			var subContent = A2(
				_merivale$victor$Victor$input,
				A2(_elm_lang$core$List$drop, 1, elaborations),
				model);
			var index = _elm_lang$core$List$length(elaborations) - 1;
			return A4(
				_merivale$victor$Victor$elaborationInput,
				_elm_lang$core$List$length(model.balances),
				index,
				_p1._0,
				subContent);
