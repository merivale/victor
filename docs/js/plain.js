...
var _merivale$victor$Interface_View_Nucleus$heading = function (model) {
...
var _merivale$victor$Interface_View_Nucleus$nucleus = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _merivale$victor$Interface_View_Nucleus$heading(model),
			_1: {
				ctor: '::',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _merivale$victor$Interface_View_Nucleus$nucleus(model),
					_1: {ctor: '[]'}
				}
			}
		});
