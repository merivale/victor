...
var _merivale$victor$Interface_Messages_Plain$propertyEmpty = function (status) {
	var _p0 = status;
	if ((_p0.ctor === 'Just') && (_p0._0.ctor === 'Absolute')) {
		return _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$String$length(_p0._0._0),
			0);
	} else {
		return false;
	}
};
var _merivale$victor$Interface_Messages_Plain$verbalityEmpty = function (verbality) {
	var _p1 = verbality;
	if (_p1.ctor === 'Do') {
		return _elm_lang$core$Native_Utils.eq(
...
var _merivale$victor$Interface_Messages_Plain$message = function (model) {
	return _merivale$victor$Interface_Messages_Plain$verbalityEmpty(model.verbality) ? _elm_lang$core$Result$Err('please enter a verb for the verbality') : (_merivale$victor$Interface_Messages_Plain$propertyEmpty(model.status) ? _elm_lang$core$Result$Err('please enter an adjective for the status') : _elm_lang$core$Result$Ok(
		{
			ctor: '_Tuple2',
			_0: model.object,
			_1: {
				ctor: '_Tuple2',
				_0: {ctor: '_Tuple2', _0: model.verbality, _1: model.status},
				_1: model.balances
			}
		}));
};
...
var _merivale$victor$Theory_Plain_Sentences$verbPhrase = F2(
	function (object, pivot) {
		var _p0 = A2(_merivale$victor$Theory_Words_Fulcrums$fulcrum, false, pivot);
		var base = _p0._0;
		var rest = _p0._1;
		return {
			ctor: '::',
			_0: A3(_merivale$victor$Theory_Words_Verbs$conjugate, object, false, base),
			_1: rest
		};
	});
var _merivale$victor$Theory_Plain_Sentences$predicate = F2(
	function (object, _p1) {
		var _p2 = _p1;
		return A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_merivale$victor$Theory_Plain_Sentences$verbPhrase, object, _p2._0),
			A2(
				_elm_lang$core$List$map,
				_merivale$victor$Theory_Words_Counters$counter(object),
				_p2._1));
	});
var _merivale$victor$Theory_Plain_Sentences$subject = function (object) {
	return _merivale$victor$Theory_Words_Pronouns$direct1(object);
};
var _merivale$victor$Theory_Plain_Sentences$sentence = function (_p3) {
	var _p4 = _p3;
	var _p5 = _p4._0;
	return _elm_lang$core$Result$Ok(
		A2(
			...
			{
				ctor: '::',
				_0: _merivale$victor$Theory_Plain_Sentences$subject(_p5),
				_1: A2(_merivale$victor$Theory_Plain_Sentences$predicate, _p5, _p4._1)
			}));
};

var _merivale$victor$Plain$view = function (model) {
	var result = A2(
		_elm_lang$core$Result$andThen,
		_merivale$victor$Theory_Plain_Sentences$sentence,
		_merivale$victor$Interface_Messages_Plain$message(model));
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _merivale$victor$Interface_View_Examples$examples(_merivale$victor$Interface_Model_Types$PlainTheory),
				_1: {
					ctor: '::',
					_0: A2(_merivale$victor$Interface_View_Nucleus$nucleus, _merivale$victor$Interface_Model_Types$PlainTheory, model),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _merivale$victor$Plain$main = _elm_lang$html$Html$beginnerProgram(
	{
		model: _merivale$victor$Interface_Model_State$initial(_merivale$victor$Interface_Model_Types$PlainTheory),
		update: _merivale$victor$Interface_Model_State$update,
		view: _merivale$victor$Plain$view
	})();

var Elm = {};
Elm['Plain'] = Elm['Plain'] || {};
if (typeof _merivale$victor$Plain$main !== 'undefined') {
    _merivale$victor$Plain$main(Elm['Plain'], 'Plain', undefined);
}
