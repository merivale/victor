...
var _merivale$victor$Theory_Types$Nucleus = F5(
	function (a, b, c, d, e) {
...
var _merivale$victor$Theory_Types$DifferentObject = function (a) {
	...
	_1: {
		...
		_1: {
			...
			_0: _elm_lang$core$Maybe$Just(
				_merivale$victor$Theory_Types$DifferentObject(_merivale$victor$Theory_Types$Speaker)),
			_1: {
				ctor: '::',
				_0: _elm_lang$core$Maybe$Just(
...
var _merivale$victor$Interface_Messages$balance = F2(
	function (ingredients, balance) {
		...
		switch (_p1.ctor) {
			...
			case 'DifferentObject':
				return _merivale$victor$Theory_Types$DifferentObject(
...
var _merivale$victor$Theory_Messages$displaceVerb = F4(
	...
	function (preferSeem, vars) {
		if (vars.past) {
			...
			if (!_elm_lang$core$Native_Utils.eq(vars.modality, _elm_lang$core$Maybe$Nothing)) {
				...
				var newVars = A4(
					_merivale$victor$Theory_Messages$displaceVerb,
					vars,
					newVerb,
...
var _merivale$victor$Theory_Messages$imminent = function (vars) {
	if (vars.past) {
...
var _merivale$victor$Theory_Messages$ongoing = function (vars) {
	if (vars.past) {
		...
		if (vars.prior) {
			...
			if (vars.ongoing) {
				...
				if (!_elm_lang$core$Native_Utils.eq(vars.modality, _elm_lang$core$Maybe$Nothing)) {
					...
					var newVars = A4(_merivale$victor$Theory_Messages$displaceVerb, vars, 'be', _elm_lang$core$Maybe$Nothing, _merivale$victor$Theory_Words$ongoing);
					return _elm_lang$core$Result$Ok(
						_elm_lang$core$Native_Utils.update(
							newVars,
	...
	if (vars.prior) {
		...
		if ((!_elm_lang$core$Native_Utils.eq(vars.modality, _elm_lang$core$Maybe$Nothing)) && (vars.projective && (!vars.past))) {
			...
			if ((!_elm_lang$core$Native_Utils.eq(vars.modality, _elm_lang$core$Maybe$Nothing)) && (!vars.projective)) {
				...
				var newVars = A4(_merivale$victor$Theory_Messages$displaceVerb, vars, 'have', _elm_lang$core$Maybe$Nothing, _merivale$victor$Theory_Words$prior);
				return _elm_lang$core$Result$Ok(
					_elm_lang$core$Native_Utils.update(
						newVars,
...
var _merivale$victor$Theory_Messages$past = function (vars) {
...
var _merivale$victor$Theory_Messages$plain = function (nucleus) {
	return {
		past: false,
		prior: false,
		ongoing: false,
		...
		balanceObject: function () {
			var _p11 = nucleus.balance;
			if (_p11.ctor === 'Nothing') {
				return false;
			} else {
				var _p12 = _p11._0;
				if (_p12.ctor === 'DifferentObject') {
					return true;
				} else {
					return false;
				}
		...
		amNeeded: _elm_lang$core$Native_Utils.eq(nucleus.object, _merivale$victor$Theory_Types$Speaker),
		isNeeded: function () {
			var _p13 = nucleus.object;
			switch (_p13.ctor) {
				case 'Male':
					return true;
				case 'Female':
			...
			if (_p14.ctor === 'Nothing') {
				...
				switch (_p15.ctor) {
					...
					case 'DifferentObject':
						return {
							ctor: '::',
							_0: _merivale$victor$Theory_Nouns$normalObject(_p15._0),
							_1: {ctor: '[]'}
						};
					default:
						return _elm_lang$core$String$words(_p15._0);
				}
			}
		}(),
		post: {ctor: '[]'}
...
var _merivale$victor$Theory_Messages$explode = function (message) {
	...
	switch (_p16.ctor) {
		case 'Plain':
			return _elm_lang$core$Result$Ok(
				_merivale$victor$Theory_Messages$plain(_p16._0));
		case 'Negative':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Messages$negative,
				_merivale$victor$Theory_Messages$explode(_p16._0));
		case 'Past':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Messages$past,
				_merivale$victor$Theory_Messages$explode(_p16._0));
		case 'Prior':
			return A2(
				_elm_lang$core$Result$andThen,
		...
		case 'Practical':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Messages$practical(_p16._0),
				_merivale$victor$Theory_Messages$explode(_p16._1));
		case 'Projective':
			return A2(
				_elm_lang$core$Result$andThen,
				A2(_merivale$victor$Theory_Messages$projective, _p16._0, _p16._1),
				_merivale$victor$Theory_Messages$explode(_p16._2));
		case 'Evasive':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Messages$evasive(_p16._0),
				_merivale$victor$Theory_Messages$explode(_p16._1));
		case 'Preordained':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Messages$preordained(_p16._0),
				_merivale$victor$Theory_Messages$explode(_p16._1));
		case 'Regular':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Messages$regular(_p16._0),
				_merivale$victor$Theory_Messages$explode(_p16._1));
		case 'Extended':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Messages$extended(_p16._0),
				_merivale$victor$Theory_Messages$explode(_p16._1));
		case 'Scattered':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Messages$scattered(_p16._0),
				_merivale$victor$Theory_Messages$explode(_p16._1));
		case 'Ongoing':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Messages$ongoing,
				_merivale$victor$Theory_Messages$explode(_p16._0));
		case 'Determined':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Messages$determined(_p16._0),
				_merivale$victor$Theory_Messages$explode(_p16._1));
		case 'Imminent':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Messages$imminent,
				_merivale$victor$Theory_Messages$explode(_p16._0));
		case 'Apparent':
			return A2(
				_elm_lang$core$Result$andThen,
				_merivale$victor$Theory_Messages$apparent(_p16._0),
				_merivale$victor$Theory_Messages$explode(_p16._1));
		case 'Indirect':
			return A2(
				_elm_lang$core$Result$andThen,
				A5(_merivale$victor$Theory_Messages$indirect, _p16._0, _p16._1, _p16._2, _p16._3, _p16._4),
				_merivale$victor$Theory_Messages$explode(_p16._5));
		case 'Enumerated':
			return A2(
				_elm_lang$core$Result$andThen,
				A4(_merivale$victor$Theory_Messages$enumerated, _p16._0, _p16._1, _p16._2, _p16._3),
				_merivale$victor$Theory_Messages$explode(_p16._4));
		default:
			return A2(
				_elm_lang$core$Result$andThen,
				A5(_merivale$victor$Theory_Messages$amassed, _p16._0, _p16._1, _p16._2, _p16._3, _p16._4),
				_merivale$victor$Theory_Messages$explode(_p16._5));
	}
};
